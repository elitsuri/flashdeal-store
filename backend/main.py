"""
FlashDeal Store - Backend API
Flash sale platform with countdown timers and inventory control
"""
...
app = FastAPI(
    title="FlashDeal Store",
    description="Flash sale platform with countdown timers and inventory control",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "FlashDeal Store"}
